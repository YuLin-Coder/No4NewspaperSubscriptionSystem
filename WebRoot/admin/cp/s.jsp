...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="<%=basePath %>admin/cp/sinfo.jsp" name="form1">
            <div class="form-group">
                <div class="label">
                    <label for="sitename">报刊名称：</label>
                </div>
                <div class="field">
                    <input type="text" class="input w50" name="word" required/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
