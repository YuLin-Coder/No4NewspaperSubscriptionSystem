...
<form name="form1" action="<%=basePath %>ComServlet?method=ewm" method="post"> 
<div class="info"> </div>
<ul> 
<li><label> </label><img src=<%=basePath %>images/ewm.png></li> 
<li><label></label><input type='submit' value="»∑∂®"> </li>
</ul>  
</div>
</form>
